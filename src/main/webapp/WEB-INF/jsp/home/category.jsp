            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    *** MENUS AND FILTERS ***
                    ...
                    <div class="card sidebar-menu mb-4">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column category-menu">
                                <li><a href="/home/category" class="nav-link">Men <span class="badge badge-secondary">42</span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="/home/category" class="nav-link">T-shirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Shirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Pants</a></li>
                                        <li><a href="/home/category" class="nav-link">Accessories</a></li>
                                    </ul>
                                </li>
                                <li><a href="/home/category" class="nav-link active">Ladies  <span class="badge badge-light">123</span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="/home/category" class="nav-link">T-shirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Skirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Pants</a></li>
                                        <li><a href="/home/category" class="nav-link">Accessories</a></li>
                                    </ul>
                                </li>
                                <li><a href="/home/category" class="nav-link">Kids  <span class="badge badge-secondary">11</span></a>
                                    <ul class="list-unstyled">
                                        <li><a href="/home/category" class="nav-link">T-shirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Skirts</a></li>
                                        <li><a href="/home/category" class="nav-link">Pants</a></li>
                    ...
                    <div class="banner"><a href="#"><img src="/resources/home/img/banner.jpg" alt="sales 2014" class="img-fluid"></a></div>
                </div>
                <div class="col-lg-9">
                    <div class="box">
                        <h1>Ladies</h1>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="product">
                                    ...
                                    <div class="flip-container">
                                        <div class="flipper">
                                            <div class="front"><a href="/home/details"><img src="/resources/product/img/${p.pPhoto}" alt="" class="img-fluid"></a></div>
                                            <div class="back"><a href="/home/details"><img src="/resources/product/img/${p.pPhoto}" alt="" class="img-fluid"></a></div>
                                        </div>
                                    </div><a href="/home/details" class="invisible"><img src="/resources/product/img/${p.pPhoto}" alt="" class="img-fluid"></a>
                                    <div class="text">
                                        <h3><a href="/home/details">${p.pDesc}</a></h3>
                                        <p class="price"> 
                                        ...
                                        <!--form for adding products in Basket-->
...
<p class="buttons">                 <a href="/home/details" class="btn btn-outline-secondary">View detail</a><input type="submit" class="btn btn-info fa fa-shopping-cart" value="Add to Cart"/>
                        ...
                        <!--                <div class="col-lg-4 col-md-6">
                                          <div class="product">
                                            ...
                                            <div class="text">
                                              <h3><a href="/home/details">White Blouse Armani</a></h3>
                                              <p class="price"> 
                                                <del>$280</del>$143.00
                                              </p>
                                              <p class="buttons"><a href="/home/details" class="btn btn-outline-secondary">View detail</a><a href="/home/basket" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a></p>
                                            </div>
                                             /.text
                        ...
                        <!--                <div class="col-lg-4 col-md-6">
                                          <div class="product">
                                            ...
                                            <div class="text">
                                              <h3><a href="/home/details">Black Blouse Versace</a></h3>
                                              <p class="price"> 
                                                <del></del>$143.00
                                              </p>
                                              <p class="buttons"><a href="/home/details" class="btn btn-outline-secondary">View detail</a><a href="/home/basket" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a></p>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                          <div class="product">
                                            ...
                                            <div class="text">
                                              <h3><a href="/home/details">White Blouse Versace</a></h3>
                                              <p class="price"> 
                                                <del></del>$143.00
                                              </p>
                                              <p class="buttons"><a href="/home/details" class="btn btn-outline-secondary">View detail</a><a href="/home/basket" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a></p>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                          <div class="product">
                                            ...
                                            <div class="text">
                                              <h3><a href="/home/details">Fur coat</a></h3>
                                              <p class="price"> 
                                                <del></del>$143.00
                                              </p>
                                              <p class="buttons"><a href="/home/details" class="btn btn-outline-secondary">View detail</a><a href="/home/basket" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a></p>
